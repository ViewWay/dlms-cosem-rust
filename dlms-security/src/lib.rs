...
pub use sm4::{sm4_encrypt, sm4_decrypt, Sm4Key, Sm4Block};
pub use kdf::{kdf, kdf_gmac};
pub use suite::SecuritySuite;
pub use hls::{HlsContext, HlsStep, HlsAuthResult};
...
#[cfg(feature = "aes")]
pub use aes_gcm_impl::{aes128_gcm_encrypt, aes128_gcm_decrypt, aes128_gmac};
...
mod tests {
    ...
    fn test_sm4_encrypt_decrypt() {
        let key = Sm4Key::from([0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF,
                                 0xFE, 0xDC, 0xBA, 0x98, 0x76, 0x54, 0x32, 0x10]);
        let plaintext = Sm4Block::from([0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF,
                                         0xFE, 0xDC, 0xBA, 0x98, 0x76, 0x54, 0x32, 0x10]);
