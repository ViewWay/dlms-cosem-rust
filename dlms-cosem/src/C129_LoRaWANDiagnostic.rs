//! IC129 LoRaWanDiagnostic
//! Blue Book Ed16: class_id=129, version=0
...
impl CosemObject for LoRaWanDiagnostic {
    fn class_id(&self) -> u16 { 129 }
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let obj = LoRaWanDiagnostic::new(ObisCode::new(0,0,0,0,0,0));
        assert_eq!(obj.class_id(), 129);
    }
    #[test]
    fn test_getter() {
        let obj = LoRaWanDiagnostic::new(ObisCode::new(0,0,0,0,0,0));
