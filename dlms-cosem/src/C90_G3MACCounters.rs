//! IC90 G3MacCounters
//! Blue Book Ed16: class_id=90, version=0
...
impl CosemObject for G3MacCounters {
    fn class_id(&self) -> u16 { 90 }
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let obj = G3MacCounters::new(ObisCode::new(0,0,0,0,0,0));
        assert_eq!(obj.class_id(), 90);
    }
    #[test]
    fn test_getter() {
        let obj = G3MacCounters::new(ObisCode::new(0,0,0,0,0,0));
