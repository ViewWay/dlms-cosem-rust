//! IC127 SchcLpwanDiagnostic
//! Blue Book Ed16: class_id=127, version=0
...
impl CosemObject for SchcLpwanDiagnostic {
    fn class_id(&self) -> u16 { 127 }
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let obj = SchcLpwanDiagnostic::new(ObisCode::new(0,0,0,0,0,0));
        assert_eq!(obj.class_id(), 127);
    }
    #[test]
    fn test_getter() {
        let obj = SchcLpwanDiagnostic::new(ObisCode::new(0,0,0,0,0,0));
        let _ = obj.messages_received();
    }
}
