...
impl LpSetup {
    pub fn new() -> Self { Self { period: 60 } }
    pub fn period(&self) -> u16 { self.period }
}

impl CosemObject for LpSetup {
    fn class_id(&self) -> u16 { 100 }
    fn logical_name(&self) -> ObisCode { ObisCode::new(0, 0, 43, 1, 0, 255) }
...
mod tests {
    use super::*;
    #[test]
    fn test_lp_setup_class_id() { assert_eq!(LpSetup::new().class_id(), 100); }
    #[test]
    fn test_lp_setup_period() { assert_eq!(LpSetup::new().period(), 60); }
}
