...
pub struct InfraredSetup { baudrate: u32 }
...
impl CosemObject for InfraredSetup {
    ...
    fn logical_name(&self) -> ObisCode { ObisCode::new(0, 0, 45, 0, 0, 255) }
...
mod tests {
    use super::*;
    #[test]
    fn test_infrared_class_id() { assert_eq!(InfraredSetup::new().class_id(), 102); }
}
