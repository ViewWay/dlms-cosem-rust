//! IC162 G3Hybrid6LoWPANSetup
//! Blue Book Ed16: class_id=162, version=0

use dlms_core::{CosemObject, CosemObjectError, DlmsData, ObisCode};

/// G3Hybrid6LoWPANSetup
pub struct G3Hybrid6LoWPANSetup {
    logical_name: ObisCode,
    lowpan_enable: bool,
    lowpan_mtu: u16,
}

impl G3Hybrid6LoWPANSetup {
...
impl CosemObject for G3Hybrid6LoWPANSetup {
    fn class_id(&self) -> u16 { 162 }
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let obj = G3Hybrid6LoWPANSetup::new(ObisCode::new(0,0,0,0,0,0));
        assert_eq!(obj.class_id(), 162);
    }
    #[test]
    fn test_getter() {
        let obj = G3Hybrid6LoWPANSetup::new(ObisCode::new(0,0,0,0,0,0));
